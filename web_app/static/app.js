...
function setMode(value){mode=value;$('mode').textContent={road:'Click road boundary points',box:'Drag around the complete car',select:'Select a car · drag road dots or measurement line',line:'Click to place the measurement line'}[value];draw();}
...
async function finishPendingRoad() {
  ...
  const next = {...profile, polygon, references: changed ? [] : profile.references};
  try {
